# Generated by Powerlevel10k configuration wizard on 2022-03-24 at 23:37 GMT.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 52170.
# Wizard options: compatible, classic, unicode, dark, blurred heads, flat tails,
...
() {
  ...
  typeset -g POWERLEVEL9K_STATUS_VERBOSE_SIGNAME=true # was false
